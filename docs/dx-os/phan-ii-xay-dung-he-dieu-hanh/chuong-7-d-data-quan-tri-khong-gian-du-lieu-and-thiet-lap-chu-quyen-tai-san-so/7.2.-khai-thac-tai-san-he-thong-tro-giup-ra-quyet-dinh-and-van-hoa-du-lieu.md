...
* Bước 4: Cấu hình trình điều khiển tương tác
  ...
  *Kích hoạt tính năng Áp dụng bộ lọc trong thuộc tính của tất cả các cấu phần biểu đồ. Cơ chế này cho phép người dùng nhấp chọn một phân đoạn dữ liệu cụ thể trên một biểu đồ bất kỳ (ví dụ: bấm vào phần biểu đồ loại yêu cầu `"Khiếu nại"`), hệ thống sẽ tự động đồng bộ lệnh lọc và điều chỉnh số liệu của toàn bộ các cấu phần hiển thị còn lại trên giao diện để chỉ xuất ra các số liệu tương quan với phân đoạn vừa chọn.*

<figure><img src="/files/sAFhySNuzDEy03K1Jh2c" alt=""><figcaption><p>(Giao diện bảng điều khiển được cấu hình bằng Looker Studio)</p></figcaption></figure>
...
*Thao tác 1: Chốt dữ liệu tĩnh có cấu trúc*
...
*Thao tác 2: Kết xuất báo cáo tĩnh phi cấu trúc*
...
*Thao tác 3: Thực thi luồng chuyển tiếp xác thực và Xử lý ngoại lệ*

...
* *Cú pháp cấu trúc:* `[Số_Thứ_Tự]_[Tên_Tài_Liệu]_[Phiên_Bản]_[Nhãn_Thời_Gian_YYYYMMDD]`
* *Số thứ tự:* Sử dụng để cưỡng chế hiển thị tệp tin theo đúng trình tự phân lớp logic của thư mục.
* *Phiên bản cuối cùng:* Khi bản ghi đạt trạng thái phê duyệt cao nhất, tham số phiên bản được chuyển dịch thành cụm ký tự cuối cùng cố định.
...
* *Cú pháp cấu trúc:* `[YYYYMMDD]_[Bộ_Phận_Hoặc_Dự_Án]_[Tên_Tài_Liệu]`
* *Ví dụ cấu trúc chuẩn:*

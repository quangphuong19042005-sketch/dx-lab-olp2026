...
*1. Đồng bộ Lược đồ Cơ sở dữ liệu vật lý*
...
*2. Cấu hình Thuộc tính Hiển thị và Rào chắn Ràng buộc*
...
*3. Cập nhật Thuật toán Nút lệnh Điều hướng Trạng thái*
...
*4. Thiết lập Bộ lọc Bảo mật Phân quyền Cấp dòng*

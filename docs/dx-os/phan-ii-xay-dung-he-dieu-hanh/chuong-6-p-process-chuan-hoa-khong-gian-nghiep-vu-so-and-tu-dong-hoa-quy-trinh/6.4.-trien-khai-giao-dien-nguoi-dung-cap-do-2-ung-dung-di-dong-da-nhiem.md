...
<figure><img src="/files/mUihsCx1GmPi2mIT6yCX" alt=""><figcaption><p>(Yêu cầu chờ xử lý)</p></figcaption></figure>
{% endcolumn %}

{% column %}

<figure><img src="/files/q4o83KVPuHn1WrndjuPs" alt=""><figcaption><p>(Yêu cầu đã xử lý)</p></figcaption></figure>
{% endcolumn %}

{% column %}

<figure><img src="/files/HL0KzDz0gphCIv9m4Hu3" alt=""><figcaption><p>(Yêu cầu đã đóng)</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
<figure><img src="/files/tJIhevheLaTLBiFlYveY" alt=""><figcaption><p>(Tạo yêu cầu mới)</p></figcaption></figure>
{% endcolumn %}

{% column %}

<figure><img src="/files/NGZVHa1YYyXn2bX2G3om" alt=""><figcaption><p>(Hành động bắt đầu xử lý)</p></figcaption></figure>
{% endcolumn %}

{% column %}

<figure><img src="/files/lBAbCWeC3AB7zUWWeC5b" alt=""><figcaption><p>(Hành động kết thúc xử lý)</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
